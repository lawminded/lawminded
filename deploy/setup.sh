...
echo "        sudo certbot --nginx -d lawminded.co.in -d www.lawminded.co.in \\"
echo "                             -d lawminded.in -d www.lawminded.in"
echo "      (all four: .co.in is the canonical site, .in 301s to it)"
echo "============================================================"
